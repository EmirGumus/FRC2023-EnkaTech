...
public class AutoBalanceAndTaxiCUBE extends SequentialCommandGroup {
  /** Creates a new AutoBalance. */
  public AutoBalanceAndTaxiCUBE(Swerve driveSubsystem ,IntakeSub m_IntakeSub,RotationSub m_RotationSub,SliderSub m_SliderSub,ElevatorSub m_ElevatorSub, PneumaticSub m_PneumaticSub) {
    ...
    .andThen(new Zero(m_RotationSub, m_SliderSub, m_ElevatorSub)).withTimeout(1.7),
      ...
      new RunCommand(() -> driveSubsystem.driveAuto(-0.8, 0.0, 0.0, true), driveSubsystem).withTimeout(2.5),
      new RunCommand(() -> driveSubsystem.driveAuto(-0.7, 0.0, 0.0, true), driveSubsystem).until(() -> driveSubsystem.isAtAutoBalanceAngle()),
         ...
         new RunCommand(() -> driveSubsystem.driveAuto(0.4, 0.0, 0.0, true), driveSubsystem)
