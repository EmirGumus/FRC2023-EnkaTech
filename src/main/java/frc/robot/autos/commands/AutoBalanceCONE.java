...
public class AutoBalanceCONE extends SequentialCommandGroup {
  /** Creates a new AutoBalance. */
  public AutoBalanceCONE(Swerve driveSubsystem ,RotationSub m_RotationSub,SliderSub m_SliderSub,ElevatorSub m_ElevatorSub, PneumaticSub m_PneumaticSub) {
    ...
    new RunCommand(() -> driveSubsystem.driveAuto(-0.7, 0.0, 0.0, true), driveSubsystem).withTimeout(3),//çalışan -0.7
      new RunCommand(() -> driveSubsystem.driveAuto(-0.3, 0.0, 0.0, true), driveSubsystem).until(() -> driveSubsystem.isAtAutoBalanceAngle()),
         //.withTimeout(3),
