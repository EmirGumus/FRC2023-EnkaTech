...
public class ElevatorUp extends CommandBase {
  ...
  public ElevatorUp(ElevatorSub _ElevatorSub) {
  ...
  public void execute() {
    ...
    m_speed = (Constants.torso.m_distance_elevator-e_encoder)* Constants.torso.elevatorKP;
    m_elevatorSub.runElevator(m_speed);

    if(e_encoder <= Constants.torso.m_distance_elevator){
