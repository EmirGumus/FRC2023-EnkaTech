...
public class ElevatorHalfUpHangar extends CommandBase {
  private final ElevatorSub m_elevatorSub;
  private double m_speed;
  private double e_encoder;
  double error=-32;

  public ElevatorHalfUpHangar(ElevatorSub _ElevatorSub) {
  ...
  public void execute() {
    ...
    m_speed = (Constants.torso.m_distance_elevatorHalfHangar+error -e_encoder)* Constants.torso.elevatorKP;
    m_elevatorSub.runElevator(m_speed);
    
   if(e_encoder <= Constants.torso.m_distance_elevatorHalfHangar){
