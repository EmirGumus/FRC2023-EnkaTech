...
public class SwerveModule {
    ...
    public void setDesiredState(SwerveModuleState desiredState, boolean isOpenLoop){
        //This is a custom optimize function,
        //Since default WPILib optimize assumes continuous controller which CTRE and Rev onboard is not
    ...
    private Rotation2d getAngle(){
        return Rotation2d.fromDegrees(
            Conversions.falconToDegrees(mAngleMotor.getSelectedSensorPosition(), 
